	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)	throws ServletException, IOException {
        ...
        if(tag.equals("authenticate")){
            ...
            try{
                ...
                String sqlS = "INSERT INTO surveys(org_id, sub_county_id, health_worker_id, village_name, household_number, household_member, location_lat, location_lng, remarks) "
                            + " VALUES ( " 
                            + basicInfo.getInt("org_id") + ", " 
                            + basicInfo.getInt("subCounty") + " , " 
                            + basicInfo.getInt("health_worker_id")  + ", '" 
                            + basicInfo.getString("village") + "', '" 
			...
			String dbconfig = "java:/comp/env/jdbc/database";
			BDB db = new BDB(dbconfig);log.info("Connection Opened--------------");
			int success = 0; String message = "You have No retruned Surveys.";
            ...
            try{
                ...
                String chkSql = "SELECT survey_id, org_id, sub_county_id, health_worker_id, village_name, household_number, household_member, survey_time, location_lat, location_lng, COALESCE(remarks, 'None'::text) AS remarks , COALESCE(return_reason, 'None'::text) AS return_reason FROM surveys WHERE survey_status = 2  AND health_worker_id = " + health_worker_id;
                log.info("SQL : " + chkSql);
                ...
                while (rs.next()) {
                    ...
                    basicInfo.put("sub_county_id", rs.getInt("sub_county_id"));
                    ...
                    success = 1; message = "You have retruned Surveys.";
                }
            ...
            try{
                ...
                if(surveyId != -1){
                    String sqlSurvey = "UPDATE surveys SET " 
                            + " sub_county_id = " + basicInfo.getInt("subCounty") 
                            + " , health_worker_id= " + basicInfo.getInt("health_worker_id")  
                            + " , village_name= '" + basicInfo.getString("village")  + "', " 
            ...
            try{
                ...
                String sqlS = "INSERT INTO survey_100( org_id, health_worker_id, form_serial, patient_name, patient_gender, patient_age, community_healt_unit, link_health_facility, referral_reason, " 
                            + " treatment, comments, sub_location, village, community_unit, receiving_officer_name, receiving_officer_profession, health_facility_name, action_taken ) "
                            + " VALUES ( " 
                            ...
                            + jsonObject.getString("sublocation") + "', '"
        ...
        else if(tag.equals("getSublocations") || tag.equals("getVillages") ){
            
            log.info("Reached : " + tag);
			String dbconfig = "java:/comp/env/jdbc/database";
			BDB db = new BDB(dbconfig);log.info("Connection Opened--------------");
			int success = 0; String message = "No Villages Available";
            ...
            try{
                ...
                success = 1; message = "Locations Loaded succ.";
